...
tf.app.flags.DEFINE_string("ps_ip", "", "IP address of the parameter server")
tf.app.flags.DEFINE_string("worker1_ip", "", "IP address of the worker1 server")
tf.app.flags.DEFINE_string("worker2_ip", "", "IP address of the worker2 server")
tf.app.flags.DEFINE_string("worker3_ip", "", "IP address of the worker3 server")
FLAGS = tf.app.flags.FLAGS

# cluster specification
parameter_servers = [FLAGS.ps_ip]
workers = [	FLAGS.worker1_ip, 
			FLAGS.worker2_ip,
			FLAGS.worker3_ip]
